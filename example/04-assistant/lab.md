...
- `service_replicas_set` — Изменение количества реплик сервиса
- `service_restart_trigger` — Рестарт сервиса через масштабирование в `0` и возврат прежнего числа реплик
...
- `docker_secret_list` — Получение списка секретов Docker Swarm
