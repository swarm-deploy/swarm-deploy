...
- **Init Deploy Jobs** run before `docker stack deploy`, with service networks, secrets, configs, environment, commands, and timeouts. See [Init Deploy Jobs](./docs/init-deploy-jobs.md).
